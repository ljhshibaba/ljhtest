...
def send_msg(title, content):
    ...
    r = requests.get(url, params={'token': '0f3a1b634b2a4452bdb3050274abe7c9',
                                  'title': title,
                                  'content': content})
    logging.info(f'通知推送结果：{r.status_code, r.text}')
...
def select_geo(i: str):
    ...
    print(2)
    print(resp)
    # f"https: // restapi.amap.com / v3 / geocode / geo?address = 北京市朝阳区阜通东大街6号 & output = XML & key = <>"
