...
'''
PUSH_TOKEN = os.environ.get("1a607039f9254cc694fdb45f5be3c987")
PUSH_TOKEN="1a607039f9254cc694fdb45f5be3c987"
print(os.environ)
'''
*********** 地图配置 ***********
获取地点信息,这里用的高德api,需要自己去高德开发者平台申请自己的key
'''
AMAP_KEY = os.environ.get("336f27edd2272004bfea1c11b46eb7a1")
AMAP_KEY = "336f27edd2272004bfea1c11b46eb7a1"
print(1)
print(AMAP_KEY)
